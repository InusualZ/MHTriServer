...
{
    public class AnsFriendList : Packet
    {
        public const uint PACKET_ID = 0x66540200;

        private List<FriendData> m_friends;

        public IReadOnlyList<FriendData> Friends => m_friends;

        public AnsFriendList(List<FriendData> friends) : base(PACKET_ID) => m_friends = friends;

        public AnsFriendList(uint id, ushort size, ushort counter) : base(id, size, counter) { }
